...
use Carbon\Carbon; //formato de fecha y hora de nuestra zona horaria
use Response;
...
class IngresoController extends Controller
{
    ...
    public function show($id){//muestra el ingreso y detalle segun lo que se le pase
        ...
        ->groupBy('i.idingreso','i.fecha_hora','p.nombre','i.tipo_comprobante', 'i.serie_comprobante', 'i.num_comprobante','i.impuesto','i.estado')
    		->first();//obtengo el primer ingreso que cumple con el parametro $id
    	$detalles=DB::table('detalle_ingreso as d')//todos los detalles de ese ingreso especifico
